...
export const ShareIcon = ({
  ...
  <svg
    ...
    height={height}
  >
    <g mirror-in-rtl="" className={className}>
      <path
...
export const QueueIcon = ({
  ...
  height = "1.4rem",
  className, }) => (
  <svg viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" focusable="false" className={className} width={width} height={height}><g className={className}><path d="M21,16h-7v-1h7V16z M21,11H9v1h12V11z M21,7H3v1h18V7z M10,15l-7-4v8L10,15z" className={className}></path></g></svg>
);
...
export const WatchLaterIcon = ({
  ...
  height = "1.4rem",
  className, }) => (
  <svg viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" focusable="false" className={className} width={width} height={height}><g className={className}><path d="M14.97,16.95L10,13.87V7h2v5.76l4.03,2.49L14.97,16.95z M12,3c-4.96,0-9,4.04-9,9s4.04,9,9,9s9-4.04,9-9S16.96,3,12,3 M12,2c5.52,0,10,4.48,10,10s-4.48,10-10,10S2,17.52,2,12S6.48,2,12,2L12,2z" className={className}></path></g></svg>
);
